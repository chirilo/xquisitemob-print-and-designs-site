...
<html>
<head>
<title>Xquisite Mob Prints &amp; Designs | Shoes</title>
	...
	<div class="main">
		...
		<div class="grids_of_3">
			<div class="grid1_of_3">
				<a href="details.html">
					<img src="../assets/web/images/shoe_pic1.jpg" alt=""/>
					<h3>branded shoes</h3>
					<div class="price">
			...
			<div class="grid1_of_3">
				<a href="details.html">
					<img src="../assets/web/images/shoe_pic2.jpg" alt=""/>
					<h3>branded shoes</h3>
					<div class="price">
						<h4>$499<span>indulge</span></h4>
					</div>
			...
			<div class="grid1_of_3">
				<a href="details.html">
					<img src="../assets/web/images/shoe_pic3.jpg" alt=""/>
					<h3>branded shoes</h3>
					<div class="price">
						<h4>$499<span>indulge</span></h4>
					</div>
		...
		<div class="grids_of_3">
			<div class="grid1_of_3">
				<a href="details.html">
					<img src="../assets/web/images/shoe_pic4.jpg" alt=""/>
					<h3>branded shoes</h3>
					<div class="price">
						<h4>$499<span>indulge</span></h4>
					</div>
			...
			<div class="grid1_of_3">
				<a href="details.html">
					<img src="../assets/web/images/shoe_pic5.jpg" alt=""/>
					<h3>branded shoes</h3>
					<div class="price">
						<h4>$499<span>indulge</span></h4>
					</div>
			...
			<div class="grid1_of_3">
				<a href="details.html">
					<img src="../assets/web/images/shoe_pic6.jpg" alt=""/>
					<h3>branded shoes</h3>
					<div class="price">
						<h4>$499<span>indulge</span></h4>
					</div>
