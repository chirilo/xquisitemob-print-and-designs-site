...
<html>
<head>
<title>Xquisite Mob Prints &amp; Designs | Sale</title>
...
<script src="../assets/web/js/jquery.min.js"></script> 
	...
	<script type="text/javascript" src="../assets/web/js/jquery.mixitup.min.js"></script>
...
<div class="wrap">	
	...
	<!-- start gallery_sale  -->
			...
			<div class="portfolio logo1" data-cat="logo">
				<div class="portfolio-wrapper">				
					<a  href="details.html">
						<img src="../assets/web/images/sale_pic1.jpg"  alt="Image 2" />
					</a>
					<div class="label">
			...
			<div class="portfolio app" data-cat="app">
				<div class="portfolio-wrapper">			
					<a  href="details.html">
						<img src="../assets/web/images/sale_pic2.jpg"  alt="Image 2" />
					</a>
					<div class="label">
						<div class="label-text">
			...
			<div class="portfolio web" data-cat="web">
				<div class="portfolio-wrapper">						
					<a  href="details.html">
						<img src="../assets/web/images/sale_pic3.jpg"  alt="Image 2" />
					</a>
					<div class="label">
						<div class="label-text">
			...
			<div class="portfolio card" data-cat="card">
				<div class="portfolio-wrapper">			
					<a  href="details.html">
						<img src="../assets/web/images/sale_pic4.jpg"  alt="Image 2" />
					</a>
					<div class="label">
						<div class="label-text">
			...
			<div class="portfolio app" data-cat="app">
				<div class="portfolio-wrapper">
					<a  href="details.html">
						<img src="../assets/web/images/sale_pic5.jpg"  alt="Image 2" />
					</a>
					<div class="label">
						<div class="label-text">
							<a class="text-title">ethnic fashion guide: tees</a>
			...
			<div class="portfolio card" data-cat="card">
				<div class="portfolio-wrapper">			
					<a  href="details.html">
						<img src="../assets/web/images/sale_pic6.jpg"  alt="Image 2" />
					</a>
					<div class="label">
						<div class="label-text">
							<a class="text-title">fasttrack: watches</a>
			...
			<div class="portfolio web" data-cat="web">
				<div class="portfolio-wrapper">						
					<a  href="details.html">
						<img src="../assets/web/images/sale_pic7.jpg"  alt="Image 2" />
					</a>
					<div class="label">
						<div class="label-text">
			...
			<div class="portfolio card" data-cat="card">
				<div class="portfolio-wrapper">			
					<a  href="details.html">
						<img src="../assets/web/images/sale_pic8.jpg"  alt="Image 2" />
					</a>
					<div class="label">
						<div class="label-text">
			...
			<div class="portfolio app" data-cat="app">
				<div class="portfolio-wrapper">
					<a  href="details.html">
						<img src="../assets/web/images/sale_pic9.jpg"  alt="Image 2" />
					</a>
					<div class="label">
						<div class="label-text">
			...
			<div class="portfolio card" data-cat="card">
				<div class="portfolio-wrapper">			
					<a  href="details.html">
						<img src="../assets/web/images/sale_pic10.jpg"  alt="Image 2" />
					</a>
					<div class="label">
						<div class="label-text">
			...
			<div class="portfolio card" data-cat="card">
				<div class="portfolio-wrapper">			
					<a  href="details.html">
						<img src="../assets/web/images/sale_pic11.jpg"  alt="Image 2" />
					</a>
					<div class="label">
						<div class="label-text">
			...
			<div class="portfolio logo1" data-cat="logo">
				<div class="portfolio-wrapper">			
					<a  href="details.html">
						<img src="../assets/web/images/sale_pic12.jpg"  alt="Image 2" />
					</a>
					<div class="label">
						<div class="label-text">
	...
	<script type="text/javascript" src="../assets/web/js/fliplightbox.min.js"></script>
