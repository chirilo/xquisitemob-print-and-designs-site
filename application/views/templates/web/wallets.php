...
<html>
<head>
<title>Xquisite Mob Prints &amp; Designs | Walltes</title>
	...
	<div class="header_sub">
		<div class="h_menu">
			<ul>
				...
				<li class="active"><a href="wallets.html">wallets</a></li> |
				<li><a href="sale.html">sale</a></li> |
	...
	<div class="main">
		...
		<div class="grids_of_3">
			<div class="grid1_of_3">
				<a href="details.html">
					<img src="assets/web/images/w_pic1.jpg" alt=""/>
			...
			<div class="grid1_of_3">
				<a href="details.html">
					<img src="assets/web/images/w_pic2.jpg" alt=""/>
					<h3>branded handbags</h3>
					<div class="price">
						<h4>$299 <span>indulge</span></h4>
					</div>
			...
			<div class="grid1_of_3">
				<a href="details.html">
					<img src="assets/web/images/w_pic3.jpg" alt=""/>
					<h3>branded handbags</h3>
					<div class="price">
						<h4>$299<span>indulge</span></h4>
					</div>
		...
		<div class="grids_of_3">
			<div class="grid1_of_3">
				<a href="details.html">
					<img src="assets/web/images/w_pic4.jpg" alt=""/>
					<h3>branded handbags</h3>
					<div class="price">
						<h4>$299<span>indulge</span></h4>
					</div>
			...
			<div class="grid1_of_3">
				<a href="details.html">
					<img src="assets/web/images/w_pic5.jpg" alt=""/>
					<h3>branded handbags</h3>
					<div class="price">
						<h4>$299<span>indulge</span></h4>
					</div>
			...
			<div class="grid1_of_3">
				<a href="details.html">
					<img src="assets/web/images/w_pic6.jpg" alt=""/>
					<h3>branded handbags</h3>
					<div class="price">
						<h4>$299<span>indulge</span></h4>
					</div>
